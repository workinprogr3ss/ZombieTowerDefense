export function loadImages(scene) {
    ...
    scene.load.image('missile_tower_1', 'src/assets/images/towers/testing/PNG/Missile_Launcher.png');
    scene.load.image('flame_tower_1', 'src/assets/images/towers/testing/PNG/MG.png');
    ...
    scene.load.image('flame_projectile', 'src/assets/images/towers/testing/PNG/Bullet_MG.png');
