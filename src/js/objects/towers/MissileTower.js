...
export default class MissileTower extends Tower {
    constructor(scene, x, y) {
        ...
        this.on('pointerdown', () => {
            ...
            const upgrade_attackSpeed_text = scene.add.text(this.x - 80, this.y, '+500 Speed', {fill: '#000000'}).setOrigin(0, 0.5).setDepth(3);
            const upgrade_range_text = scene.add.text(this.x - 80, this.y + 32, '+10 Range', {fill: '#000000'}).setOrigin(0, 0.5).setDepth(3);
